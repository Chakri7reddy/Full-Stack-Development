...
<title>Candidate Register Here</title>
					...
					<div class="card-body">
						<form action="CandidateServlet" method="post" enctype="multipart/form-data">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="enteryourname" name="name">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="exampleInputAddress">Age</label>
								<input type="number" class="form-control" id="exampleInputAddress" name="age">
							</div>
							<div class="form-group">
								<label for="enterDOB">DOB</label>
								<input type="date" class="form-control" id="enterDOB" name="DOB">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="exampleFathername" name="fathername">
							</div>
							<div class="form-group">
								<label for="exampleInputQualification">Qualification</label>
								<input type="text" class="form-control" id="exampleQualification" name="qualification">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">PartyName</label>
								<input type="text" class="form-control" id="exampleInputPartyname" name="partyname">
							</div>
					
							<div class="form-group">
								<label for="exampleInputPassword1">Experience</label>
								<input type="text" class="form-control" id="exampleInputexperience" name="experience">
